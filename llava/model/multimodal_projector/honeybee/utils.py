...
from .model import get_num_params
from .dist import print_rank_0
...
def print_trainable_parameters(model):
    ...
    vision_params = get_num_params(model.vision_model)
    proj_params = get_num_params(model.abstractor)
    llm_params = get_num_params(model.language_model)
    print_rank_0(
